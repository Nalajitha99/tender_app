...
if (in_array($userName, $allowedAll)) {
    ...
    $where = "WHERE status='Uncompleted' AND assignedBy = '" . $conn->real_escape_string($userName) . "'";
}
...
$pdf->SetTitle('Not Submitted Tenders Report');
$pdf->SetMargins(10, 10, 10);
$pdf->SetAutoPageBreak(TRUE, 10);
$pdf->AddPage();

// --- PDF Header ---
$html = '<h2 style="text-align:center;">Not Submitted Tenders Report</h2>';
...
$pdf->Output('Not_Submitted_Tenders_Report.pdf', 'I');
