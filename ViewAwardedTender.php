            ...
            <div class="col-12 col-lg-10 col-xl-10">
                ...
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-3"><?php echo $tender['organization']; ?> Awarded Tender</h3><hr><br>
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <label class="form-label" for="recievedTime">Received Time</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-4">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <label>
                                    <input type="radio" name="awardStatus" value="Awarded" 
                                        <?php if($tender['awardStatus']=="Awarded") echo 'checked'; ?> readonly>
                                    Awarded
                                </label>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <label>
                                    <input type="radio" name="awardStatus" value="Pending"
                                        <?php if($tender['awardStatus']=="Pending") echo 'checked'; ?> readonly>
                                    Pending
                                </label>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <label>
                                    <input type="radio" name="awardStatus" value="Not Awarded"
                                        <?php if($tender['awardStatus']=="Not Awarded") echo 'checked'; ?> readonly>
                                    Not Awarded
                                </label>
                            </div>
                        </div>
    ...
    function showBidSecurity() {
        ...
        if (value === "Yes") {
            ...
            function toggleReadingFields() {
                ...
                if (readings === "Collected") {
                    document.getElementById('yField').style.display = "block";
                    document.getElementById('yFields').style.display = "block";
                } else {
                    document.getElementById('yField').style.display = "none";
                    document.getElementById('yFields').style.display = "none";
                }
            }
