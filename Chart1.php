...
// -------------------------------
// FETCH TOTAL TENDER COUNT
// -------------------------------
$totalTenders = $conn->query("SELECT COUNT(*) AS total FROM tenders WHERE 1 $dateFilter $assignedFilter")->fetch_assoc()['total'];
...
// -------------------------------
// FETCH SALES COUNTS PER SALESPERSON
// -------------------------------
