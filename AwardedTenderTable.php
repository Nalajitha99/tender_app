...
<div class="container-fluid">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0"> 
        ...
        <li class="nav-item" style="background-color:rgb(255, 255, 255, 0.3);border-radius:10px"><a class="nav-link active" href="AwardedTenderTable.php" style="font-weight:bold;">Awarded Tenders</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
    </ul>&nbsp;&nbsp;&nbsp;&nbsp;
...
function printPDF(){
    ...
    const url = `PrintAwarded.php?organization=${encodeURIComponent(customer)}&user=${encodeURIComponent(filterUser)}&startDate=${startDate}&endDate=${endDate}`;
...
function loadSalesData(page = 1) {
    ...
    let url = `AwardedTenderTableDone.php?page=${page}&limit=5&organization=${encodeURIComponent(customer)}&user=${encodeURIComponent(filterUser)}`;
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            data.data.forEach(row => {
                ...
                `;
                tr.onclick = () => window.location.href = `ViewAwardedTender.php?id=${row.id}`;
