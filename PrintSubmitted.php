...
if (in_array($userName, $allowedAll)) {
    ...
    $where = "WHERE status='Completed' AND assignedBy = '" . $conn->real_escape_string($userName) . "'";
}
...
$pdf->SetTitle('Submitted Tenders Report');
$pdf->SetMargins(10, 10, 10);
$pdf->SetAutoPageBreak(TRUE, 10);
$pdf->AddPage();

// --- PDF Header ---
$html = '<h2 style="text-align:center;">Submitted Tenders Report</h2>';
...
$pdf->Output('Submitted_Tenders_Report.pdf', 'I');
