...
<div class="container-fluid">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0"> 
        ...
        <?php } ?>
        <li class="nav-item" style="background-color:rgb(255, 255, 255, 0.3);border-radius:10px"><a class="nav-link active" href="SubmittedTenderTable.php" style="font-weight:bold;">Submitted Tenders</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
